...
I am comfortable submitting this repository as my work because every decision was reviewed and accepted rather than pasted in without verification. AI helped draft models, tests, the frontend, CI, and Docker configuration, but I ran the pytest suite and manual checks myself and reviewed each changed area before submitting. I graded Module 5 findings using file evidence instead of accepting every AI-reported issue. I placed items I am not ready to fix, such as XSS escaping and the initial-status policy, on the backlog instead of claiming they were resolved. These final evidence files document what I verified, rejected, and intentionally kept out of scope for this learning project.
